...
MongoStorage = (function() {
  ...
  MongoStorage.prototype.downloadById = function(container, id, res, callback) {
    var self;
    if (callback == null) {
      callback = (function() {});
    }
    self = this;
    return this.getFileById(ObjectID(id), function(err, file) {
      if (err) {
        return callback(err);
      }
...
MongoStorage.prototype.downloadById.http = {
  verb: 'get',
  path: '/:container/downloadById/:fileId'
};
